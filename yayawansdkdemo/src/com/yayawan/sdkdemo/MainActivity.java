...
import com.yayawan.sdk.jfpay.YuepayDialog;
 ...
 * 
 * 2.闪屏动画,在游戏启动时的第一个  页面出现..只要保证游戏画面出来前调用即可
...
public class MainActivity extends Activity {
	...
	public static String textxinx="";
	public static PayResult mFirstResult;
...
*/
		...
		Button mweixinpayButton = new Button(this);
		mweixinpayButton.setText("微信支付");
		mweixinpayButton.setOnClickListener(new OnClickListener() {
		...
		mLinearLayout.addView(mweixinpayButton, new LinearLayout.LayoutParams(
				LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT));
	...
	private void weiXinPay() throws Exception {
		// TODO Auto-generated method stub
	 /*  PayResult mPayresult=ViewConstants.mPayResult;
		//System.out.println(k.toString());
		Yayalog.loger("weiXinPayLoad");
		PayReq request = new PayReq();

		request.appId = ""+mPayresult.params.get("appid");
		Yayalog.loger("appid"+mPayresult.params.get("appid"));
		request.partnerId =mPayresult.params.get("partnerid");
		Yayalog.loger("partnerid"+mPayresult.params.get("partnerid"));
		request.prepayId= mPayresult.params.get("prepayid");

		request.packageValue = "Sign=WXPay";

		request.nonceStr=  mPayresult.params.get("noncestr");

		request.timeStamp=  mPayresult.params.get("timeStamp");

		request.sign=  mPayresult.params.get("sign");
		Yayalog.loger("weiXinPayLoad:"+request.toString());
	...
	/*	PayReq req = new PayReq();
		...
		req.prepayId		="wx20161220145024b36f28463b0496315562";
		req.nonceStr		= "eVY5634tuKQ5JvEW";
		req.timeStamp		= "1482216624";
		req.packageValue	="Sign=WXPay";
		req.sign			= "79B168B66F91E33B00858CCE826BD77F";
	...
	public void anim(View v) {
		...
		msgApi = WXAPIFactory.createWXAPI(MainActivity.this, "wxf5024e91d99cde0d", true);
		//msgApi= WXAPIFactory.createWXAPI(mActivity, null);
		Yayalog.loger("我开始注册微信支付了");
		if (msgApi!=null) {
			Yayalog.loger("我注册微信支付了");
			boolean registerApp = msgApi.registerApp("wxf5024e91d99cde0d");
			if (registerApp) {
				Yayalog.loger("微信注册成功了");
			}
		}*/
	...
	//	Intent localIntent = new Intent();
	  //  localIntent.setClassName("com.example.ceshiintentactivity", "com.example.ceshiintentactivity.MyActivity");
