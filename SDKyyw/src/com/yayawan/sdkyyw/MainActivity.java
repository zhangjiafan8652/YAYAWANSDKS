...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
    	...
    	//Toast.makeText(this, "退出回调"+this.hasWindowFocus(), Toast.LENGTH_SHORT).show();
...
//        });
	 ...
	 public void pay(View v) {
	        YYWOrder order = new YYWOrder(UUID.randomUUID().toString(), "霜之哀伤", 10000l,  "");
	 ...
	 @Override
	    ...
	    protected void onResume() {
	       ...
	       // Toast.makeText(MainActivity.this, "退出回调"+this.hasWindowFocus(), Toast.LENGTH_SHORT).show();
