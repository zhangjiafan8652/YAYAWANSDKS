...
public class UserManagerImpl implements YYWUserManager {
	...
	public void setRoleData(Activity arg0) {
		// TODO Auto-generated method stub
		Yayalog.loger("setRoleData:" + YYWMain.mRole.toString());
		/*
		 * YayaWan.setRoleData(arg0, YYWMain.mRole.getRoleId(),
	...
	public void setData(Activity paramActivity, String roleId, String roleName,
		...
		Yayalog.loger("==+++++++++++++++++++setdataroleid:"
				+ YYWMain.mRole.toString());

		YayaWan.setRoleData(paramActivity, roleId, roleName, roleLevel, zoneId,
				zoneName);
