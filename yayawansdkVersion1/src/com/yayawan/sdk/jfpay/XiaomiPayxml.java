...
public class XiaomiPayxml extends Basexml implements Layoutxml {
	...
	public View initViewxml() {
		...
		iv_weixinpay = new ImageView(mContext);
		machineFactory.MachineView(iv_weixinpay, 160, 160, 0, mLinearLayout,
				20, 0, 20, 0, 100);
		// machineFactory.MachineView(iv_weixinpay, 160, 160, 0, mLinearLayout);
		iv_weixinpay.setImageBitmap(GetAssetsutils.getImageFromAssetsFile(
				"xiaomi_weixinpaychoosed.png", mActivity));
		

		iv_alipay = new ImageView(mContext);
		machineFactory.MachineView(iv_alipay, 160, 160, 0, mLinearLayout, 20,
				0, 20, 0, 100);
		iv_alipay.setImageBitmap(GetAssetsutils.getImageFromAssetsFile(
				"xiaomi_alipaychoose.png", mActivity));
		...
		ll_icon.addView(iv_weixinpay);
		ll_icon.addView(iv_alipay);
	...
	private void initLogic() {
		// TODO Auto-generated method stub
		iv_alipay.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				iv_weixinpay.setImageBitmap(GetAssetsutils
						.getImageFromAssetsFile("xiaomi_weixinpay.png",
								mActivity));

				iv_alipay.setImageBitmap(GetAssetsutils.getImageFromAssetsFile(
						"xiaomi_alipaychoosed.png", mActivity));
		...
		iv_weixinpay.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				iv_weixinpay.setImageBitmap(GetAssetsutils
						.getImageFromAssetsFile("xiaomi_weixinpaychoosed.png",
								mActivity));
